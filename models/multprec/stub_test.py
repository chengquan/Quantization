...
class LeNet(nn.Module):
    def __init__(self, num_classes=10, init_weights=True):
        ...
        self.features = nn.Sequential(
            ...
            ##nn.MaxPool2d(2, 2)
            _conv2d(1, 6, 5, padding=0, input_bit_width=8, weight_bit_width=8, bias=False, weight_scale=-8, input_scale=-7, output_scale=-4),
            nn.MaxPool2d(2, 2),
            _conv2d(6, 16, 5, padding=0, input_bit_width=8, weight_bit_width=8, bias=False, weight_scale=-9, input_scale=-4, output_scale=-1),
            nn.MaxPool2d(2, 2)
        )
        self.classifier = nn.Sequential(
            _linear(16*5*5, 120, bias=False, input_bit_width=8,
                    weight_bit_width=8, bias_bit_width=8, weight_scale=-12, input_scale=-1, output_scale=-1),
            _linear(120, 84, bias=False, input_bit_width=8,
                    weight_bit_width=8, bias_bit_width=8, weight_scale=-12, input_scale=-1, output_scale=-2),
            QuantifiedLinear(84, num_classes, bias=False, input_bit_width=8,
                             weight_bit_width=8, bias_bit_width=8, weight_scale=-12, input_scale=-2, output_scale=-3)
        )
        if init_weights:
